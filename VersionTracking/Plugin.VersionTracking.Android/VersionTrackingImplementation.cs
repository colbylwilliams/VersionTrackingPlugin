    ...
    public class VersionTrackingImplementation : IVersionTracking
    {
        ...
        public void Track()
        {
            ...
            using (var sharedPreferences = PreferenceManager.GetDefaultSharedPreferences(Application.Context)) {
                ...
                var oldVersionList = sharedPreferences.GetStringSet(xamVersionsKey, null);

                var oldBuildList = sharedPreferences.GetStringSet(xamBuildsKey, null);
                ...
                if (oldVersionList == null || oldBuildList == null) {
                    ...
                    versionTrail = new Dictionary<string, List<string>> {
                        { xamVersionsKey, oldVersionList.ToList() },
                        { xamBuildsKey, oldBuildList.ToList() }
                    };
            ...
            if (needsSync) {
                ...
                using (var sharedPreferences = PreferenceManager.GetDefaultSharedPreferences(Application.Context)) {
                    ...
                    using (var sharedPreferencesEditor = sharedPreferences.Edit()) {
                        ...
                        sharedPreferencesEditor.PutStringSet(xamVersionsKey, versionTrail[xamVersionsKey]);
                        sharedPreferencesEditor.PutStringSet(xamBuildsKey, versionTrail[xamBuildsKey]);
        ...
        public string CurrentVersion {
            get {
                using (var pInfo = Application.Context.PackageManager.GetPackageInfo(Application.Context.PackageName, PackageInfoFlags.MetaData))
